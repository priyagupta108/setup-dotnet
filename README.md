...
> The `sdk.version` in `global.json` requires a full SDK version number. Refer to [Microsoft's documentation](https://learn.microsoft.com/en-us/dotnet/core/tools/global-json#version) for supported values.
